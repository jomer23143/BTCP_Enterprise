    ...
    public class DataSupport : IDisposable
    {
        ...
        public String ConnectionString
        {
            get
            {
                ...
                return connectString == "" ? BTCP_Enterprise.Connection.GetConnectionStringReg : connectString;
            }
        ...
        {
            using (var conn = new SqlConnection(BTCP_Enterprise.Connection.GetConnectionStringReg))
            {
                IDataReader reader;
                reader = conn.ExecuteReader(sql);
                var table = new DataTable();
